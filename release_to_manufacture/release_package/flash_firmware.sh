...
echo "Erasing Flash..."
$ESP_CMD --chip esp32 --port "$1" --baud 115200 erase_flash

echo "Flashing Firmware..."
$ESP_CMD --chip esp32 --port "$1" --baud 115200 --before default_reset --after hard_reset write_flash -z --flash_mode dio --flash_freq 40m --flash_size detect 0x1000 bootloader.bin 0x10000 firmware.bin 0x8000 partitions.bin
...
$ESP_CMD --chip esp32 --port "$1" --baud 115200 write_flash 0x290000 spiffs.bin
